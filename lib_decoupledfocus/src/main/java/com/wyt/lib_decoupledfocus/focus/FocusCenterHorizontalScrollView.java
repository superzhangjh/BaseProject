package com.wyt.lib_decoupledfocus.focus;
...
public class FocusCenterHorizontalScrollView extends HorizontalScrollView {
    ...
    public FocusCenterHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        int fadingEdge = mFadingEdge > 0 ? mFadingEdge : 80;
